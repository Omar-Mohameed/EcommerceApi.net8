        ...
        public async Task InvokeAsync(HttpContext context)
        {
            try
            {
                ...
                if (IsRequestAllowed(context) == false)
                {
                    ...
                    var response = new ResponseApi((int)HttpStatusCode.TooManyRequests, "Too many request. please try again later");
            ...
            catch (Exception ex)
            {
                ...
                var response = _environment.IsDevelopment() ?
                    new ResponseApi(statuscode: (int)HttpStatusCode.InternalServerError,ex.Message,ex.StackTrace)
                    : new ResponseApi(statuscode: (int)HttpStatusCode.InternalServerError, ex.Message);
